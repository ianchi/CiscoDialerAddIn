...
namespace Ianchi.WebDialerAddIn {
    ...
    public sealed partial class WebDialerAddIn : Microsoft.Office.Tools.Outlook.OutlookAddInBase {
        ...
        public WebDialerAddIn(global::Microsoft.Office.Tools.Outlook.Factory factory, global::System.IServiceProvider serviceProvider) : 
                base(factory, serviceProvider, "AddIn", "CiscoDialer") {
    ...
    internal sealed partial class Globals {
        ...
        private static WebDialerAddIn _WebDialerAddIn;
        ...
        internal static WebDialerAddIn WebDialerAddIn {
            get {
                return _WebDialerAddIn;
            }
            set {
                if ((_WebDialerAddIn == null)) {
                    _WebDialerAddIn = value;
                }
                else {
        ...
        internal static ThisFormRegionCollection FormRegions {
            get {
                if ((_ThisFormRegionCollection == null)) {
                    _ThisFormRegionCollection = new ThisFormRegionCollection(Globals.WebDialerAddIn.GetFormRegions());
                }
    ...
    internal sealed partial class ThisFormRegionCollection : Microsoft.Office.Tools.Outlook.FormRegionCollectionBase {
        ...
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Explorer explorer] {
            get {
                return ((WindowFormRegionCollection)(Globals.WebDialerAddIn.GetFormRegions(explorer, typeof(WindowFormRegionCollection))));
            }
        }
        
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Inspector inspector] {
            get {
                return ((WindowFormRegionCollection)(Globals.WebDialerAddIn.GetFormRegions(inspector, typeof(WindowFormRegionCollection))));
            }
        }
    }
